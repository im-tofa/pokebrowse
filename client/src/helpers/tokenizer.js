...
const parseInput = (input) => {
  ...
  if (i < tokens.length) {
    switch (tokens[i].type) {
        ...
        switch (tokens[i].token) {
          case "/species":
            ...
            if (i < tokens.length) {
              ...
              console.log(
                "command ended early; expected a word (e.g Excadrill)"
              );
            }
            ...
            if (i < tokens.length) {
              if (tokens[i].type === "DATE") {
                ...
                console.log(
                  "got token of type '" +
                    tokens[i].type +
                    "'; expected a date (e.g 2020-04-05)"
                );
                return null;
              }
              i++;
              ...
              console.log(
                "command ended early; expected a date (e.g 2020-04-05)"
              );
            }
            break;
        }
      ...
      default:
        console.log(
          "unexpected command: expected /species, /author, /speed or /date."
        );
        return null;
    }
  }
